...
/**
 * Footer component displaying logo, description, quick links, contact info, and social links.
        ...
        <div className={styles.content}>
          ...
          <div className={styles.brand}>
            <a href="/" className={styles.logo} aria-label="Go to homepage">
              {logo && <img src={logo} alt="" className={styles.logoImage} />}
              <span>{logoText}</span>
            </a>
          ...
          {/* Quick Links */}
          <nav className={styles.section} aria-labelledby="footer-quicklinks-title">
            <h3 id="footer-quicklinks-title" className={styles.sectionTitle}>Quick Links</h3>
          ...
          {/* Contact Info */}
          <div className={styles.section} aria-labelledby="footer-contact-title">
            <h3 id="footer-contact-title" className={styles.sectionTitle}>Contact Us</h3>
          ...
          {/* Social Links */}
          <div className={styles.section} aria-labelledby="footer-social-title">
            <h3 id="footer-social-title" className={styles.sectionTitle}>Follow Us</h3>
